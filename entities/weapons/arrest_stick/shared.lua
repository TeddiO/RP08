...
---------------------------------------------------------*/
  function SWEP:PrimaryAttack()
	...
	self.Owner:TraceHullAttack( self.Owner:GetShootPos(), self.Owner:GetAimVector() * 120, Vector(-16,-16,-16), Vector(36,36,36), 0, DMG_GENERIC, 0, true )
	...
	Notify( trace.Entity, 1, 3, "You've been arrested by " .. self.Owner:Nick() .."!" );
 	trace.Entity:Arrested(self.Owner);
